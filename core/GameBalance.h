...
inline int eventCoins() { return 8; }        // 旧接口保留；事件不再默认奖励 Money。
...
inline int baijiangTicketCost() { return 18; }         // 百讲最后一张票：准点蹲票买票花费 Money。
inline int baijiangTreeholeHeal() { return 6; }        // 百讲最后一张票：树洞买到票回复心情。
inline int baijiangTreeholeCost() { return 32; }       // 百讲最后一张票：树洞出票略贵，花费 Money。
...
namespace Shop
{
inline int discountPercent() { return 10; }      // 物美会员卡的折扣百分比。
...
inline int pkuWatermelonTurnBlock() { return 5; }     // 北大的瓜：每回合开始抗压值。
}
